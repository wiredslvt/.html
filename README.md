...
<head>
  ...
  <style>
    ...
    body {
      ...
      align-items: center;
      min-height: 100vh;
      background-color: #e7d3c6; /* Cor de fundo em tom pastel terroso */
      background-image: url('stars.png'); /* Referência ao arquivo local no repositório */
    ...
    .card a {
      ...
      margin: 10px 0;
      padding: 12px;
      background-color: #c8b6a6; /* Botões em tom pastel terroso */
      color: #ffffff;
